...
b_adelay = tk.Button(gui, width=3, height=1, text="OK", font=fonts['submit'], bg=Background['submit'],
                          command=lambda: submit("delay",t_delay, s_delay))
...
b_relock=tk.Button(gui, text="Relock system", command=lambda: relock(), font=fonts['main'], bg=Background['green'])
...
geths(gui).grid(row=11, column=1, columnspan=5, sticky="nwse", pady=2*pady)

l_difftitle.grid(row=12, column=y, columnspan=4, sticky="nw", pady=pady)
l_dpota_cr.grid(row=13, column=y, columnspan=1, sticky="nw", pady=pady)
t_dpota_cr.grid(row=13, column=y + 1, columnspan=1, sticky="nw", pady=pady)
s_dpota_cr.grid(row=13, column=y + 2, columnspan=1, sticky="nesw", pady=pady)
b_dpota_cr.grid(row=13, column=y + 3, columnspan=1, sticky="nwse", pady=pady)
l_dpota_amp.grid(row=14, column=y, columnspan=1, sticky="nw", pady=pady)
t_dpota_amp.grid(row=14, column=y + 1, columnspan=1, sticky="nw", pady=pady)
s_dpota_amp.grid(row=14, column=y + 2, columnspan=1, sticky="esnw", pady=pady)
b_dpota_amp.grid(row=14, column=y + 3, columnspan=1, sticky="nsew", pady=pady)
l_dpotb_cr.grid(row=15, column=y, columnspan=1, sticky="nw", pady=pady)
t_dpotb_cr.grid(row=15, column=y + 1, columnspan=1, sticky="nw", pady=pady)
s_dpotb_cr.grid(row=15, column=y + 2, columnspan=1, sticky="nwes", pady=pady)
b_dpotb_cr.grid(row=15, column=y + 3, columnspan=1, sticky="nswe", pady=pady)
l_dpotb_amp.grid(row=16, column=y, columnspan=1, sticky="nw", pady=pady)
t_dpotb_amp.grid(row=16, column=y + 1, columnspan=1, sticky="nw", pady=pady)
s_dpotb_amp.grid(row=16, column=y + 2, columnspan=1, sticky="esnw", pady=pady)
b_dpotb_amp.grid(row=16, column=y + 3, columnspan=1, sticky="nwse", pady=pady)
geths(gui).grid(row=17, column=1, columnspan=5, sticky="nwse", pady=2*pady)

l_clptitle.grid(row=18, column=y, columnspan=4, sticky="nw", pady=pady)
l_clp_ci.grid(row=19, column=y, columnspan=1, sticky="nw", pady=pady)
t_clp_ci.grid(row=19, column=y + 1, columnspan=1, sticky="nw", pady=pady)
s_clp_ci.grid(row=19, column=y + 2, columnspan=1, sticky="nesw", pady=pady)
b_clp_ci.grid(row=19, column=y + 3, columnspan=1, sticky="nswe", pady=pady)
l_clp_power.grid(row=20, column=y, columnspan=1, sticky="nw", pady=pady)
s_clp_power.grid(row=20, column=y + 1, columnspan=3, sticky="nwes", pady=pady)
geths(gui).grid(row=21, column=1, columnspan=5, sticky="nwse", pady=2*pady)


l_disclaimer.grid(row=22, column=1, columnspan=4, sticky="w", pady=pady)
b_reinit.grid(row=23, column=3, columnspan=2, sticky="nse", pady=pady, padx=3)
b_relock.grid(row=23, column=1, columnspan=2, sticky="nw", pady=pady, padx=3)
l_message_s.grid(row=24, column=1, columnspan=1, sticky="nwse", pady=pady*5)
l_message.grid(row=24, column=2, rowspan=2, columnspan=3, sticky="nwse", pady=(pady*5,0))
geths(gui).grid(row=25, column=1, columnspan=5, sticky="nwse", pady=pady*2)
