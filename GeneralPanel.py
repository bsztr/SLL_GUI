...
class GeneralPanel(tk.Frame):
    def __init__(self, master, parent):
        ...
        self.l_power_enable = tk.Label(self, text="Software power tuning:", font=fonts['main'], bg=Background['main'])
        self.t_power_enable = tk.Text(self, font=fonts['main'], width=10, height=1)
        self.s_power_enable = gui_label(self)
        ...
        self.l_power_enable.grid(row=10, column=1, columnspan=1, sticky="nw", pady=5)
