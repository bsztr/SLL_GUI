...
class ClientPanel(tk.Frame):
    ...
    def __init__(self):
        ...
        self.l_laser=tk.Label(self.gui, text="LD pump status", font=fonts['indicator'], bg=Background['main'])
        ...
        self.b_lon=tk.Button(self.gui, text="SYSTEM ON", bg=Colours['green'], fg="white", command=lambda: self.laser_on(), font=fonts['mainbutton'], height=1, width=10)
        ...
        self.b_lock=tk.Button(self.gui, text="RELOCK", fg="black", bg=Colours['grey'], command=lambda: self.lock_on(), font=fonts['subbutton'], height=1, width=10)
        ...
        self.b_more=tk.Button(self.gui, text="RESET", bg=Colours['grey'], command=lambda:  self.reset(), font=fonts['subbutton'], height=1, width=14)
        ...
        #Buttons
        self.b_lon.grid(row=22, column=1, columnspan=4, rowspan=2, sticky="nwes", padx=5, pady=(2,0))
        ...
        self.b_alignment.grid(row=22, column=5, columnspan=3, rowspan=1, sticky="nwes", pady=2, padx=(3,6))
        self.b_highp.grid(row=23, column=5, columnspan=3, rowspan=1, sticky="nwes", pady=2, padx=(3,6))
    ...
    def front_panel(self):
        ...
        if "LDR" in Globals.available:
            ...
            elif self.l_ld_curr_actual == 0 or Globals.ldrr == 1:
                self.ldr_n = tk.StringVar()
                self.l_ld_curr = tk.Label(self.gui, textvariable=self.ldr_n, font=fonts['temperature'],
                                          bg=Background['main'])
                self.getnametec("ldr", self.l_ld_curr, self.ldr_n)
        ...
        if "PZT0" in Globals.available:
            ...
            elif self.l_clp_curr_actual == 0 or Globals.pzt0r == 1:
                self.l_clp_curr = tk.Label(self.gui, text="CLP power:", font=fonts['temperature'],
                                           bg=Background['main'])
                self.l_clp_curr_actual = pzt_label(self.gui)
                self.l_clp_curr_actual.update_clp_main(getaddress("pzt0", "clp_power"), "clp_power")
        ...
        if "PZT1" in Globals.available:
            ...
            elif self.l_clp1_curr_actual == 0 or Globals.pzt1r == 1:
        ...
        if "TEC0" in Globals.available:
            ...
            elif self.l_tec0_temp_actual == 0 or Globals.tec0r == 1:
                self.tec0_n = tk.StringVar()
                self.l_tec0_temp = tk.Label(self.gui, textvariable=self.tec0_n, font=fonts['temperature'],
                                            bg=Background['main'])
                self.getnametec("tec0", self.l_tec0_temp, self.tec0_n)
        ...
        if "TEC1" in Globals.available:
            ...
            elif self.l_tec1_temp_actual == 0 or Globals.tec1r == 1:
                self.tec1_n = tk.StringVar()
                self.l_tec1_temp = tk.Label(self.gui, textvariable=self.tec1_n, font=fonts['temperature'],
                                            bg=Background['main'])
                self.getnametec("tec1", self.l_tec1_temp, self.tec1_n)
        ...
        if "TEC2" in Globals.available:
            ...
            elif self.l_tec2_temp_actual == 0 or Globals.tec2r == 1:
                self.tec2_n = tk.StringVar()
                self.l_tec2_temp = tk.Label(self.gui, textvariable=self.tec2_n, font=fonts['temperature'],
                                            bg=Background['main'])
                self.getnametec("tec2", self.l_tec2_temp, self.tec2_n)
        ...
        if "TEC3" in Globals.available:
            ...
            elif self.l_tec3_temp_actual == 0 or Globals.tec3r == 1:
                print("2")
                self.tec3_n = tk.StringVar()
                self.l_tec3_temp = tk.Label(self.gui, textvariable=self.tec3_n, font=fonts['temperature'],
                                            bg=Background['main'])
    ...
    def ld_on(self):
        ...
        if readbit(self.actual, 17) == "1":
            ...
            addvalue(control["address"], control['ld'])
